...
THESE ROLES "User" AND "jANE" ARE FOR EXAMPLE ONLY, DO NOT USE THEM DURING RESPONSE
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text('Hey there, it s your friend, Jane! How are you doing today?')
